...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post homeworks_url, params: { homework: { category: @homework.category, deadline: @homework.deadline, description: @homework.description, homework_name: @homework.homework_name } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { category: @homework.category, deadline: @homework.deadline, description: @homework.description, homework_name: @homework.homework_name } }
